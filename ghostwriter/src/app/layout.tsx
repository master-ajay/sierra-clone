...
export const metadata: Metadata = { title: 'Ghostwriter — Knowledge Base' }
    ...
    <html lang="en">
      <body className="bg-base text-gray-100 min-h-screen flex" style={{ fontFamily: 'system-ui, sans-serif' }}>
        <nav className="w-52 shrink-0 bg-surface border-r border-border flex flex-col p-4 gap-1">
          <span className="text-xs font-semibold text-muted uppercase tracking-widest mb-4 px-2">Ghostwriter</span>
          <NavLink href="/">Articles</NavLink>
          <NavLink href="/search">Search</NavLink>
          <NavLink href="/articles/new">New article</NavLink>
        </nav>
